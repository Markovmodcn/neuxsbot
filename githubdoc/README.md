...
<div align="center">
  <img src="图片/圆角编号2.png" alt="NexusBot Logo" width="80" height="80" style="border-radius: 20px;">
...
<img src="图片/NexusBot工作流.jpg" alt="NexusBot工作流设计器" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
...
<img src="图片/AI分层架构.jpg" alt="AI分层架构" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
...
<img src="图片/NexusBot多端连.jpg" alt="NexusBot多端连接" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
<img src="图片/苹果三端连接.jpg" alt="苹果三端连接" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
...
<img src="图片/NexusBot手机控.jpg" alt="NexusBot手机控制" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">

## ⏰ 全天候自动化运行

<img src="图片/24时工作流时间轴.jpg" alt="24时工作流时间轴" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
...
<img src="图片/AI能力矩阵.jpg" alt="AI能力矩阵" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
<img src="图片/苹果AI矩阵设计.jpg" alt="苹果AI矩阵设计" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
...
<img src="图片/数据反馈图表.jpg" alt="数据反馈图表" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">

### 💼 商务场景应用

<img src="图片/商务场景网格卡片.jpg" alt="商务场景网格卡片" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">

### 🔄 多渠道集成控制

<img src="图片/多渠道控制.jpg" alt="多渠道控制" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
<img src="图片/多渠道集成图标.jpg" alt="多渠道集成图标" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">

## 🏗️ 技术架构

<img src="图片/分层架构图.jpg" alt="分层架构图" style="width: 100%; border-radius: 18px; margin-bottom: 20px;">
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="图片/wx.png" alt="微信交流" style="width: 100%; max-width: 300px; border-radius: 10px; margin-right: 20px;">
  <div style="flex: 1;">
    <p><strong>关键词：</strong>AI操作系统、智能自动化、工作流编排、多模型支持、本地部署、技能系统、企业级安全、开源生态</p>
  </div>
</div>

<img src="图片/圆角编号3.jpg" alt="圆角编号3" style="width: 100%; max-width: 200px; float: right; margin-left: 20px;">
...
<div align="center">
  <img src="图片/极简数据反馈海报.jpg" alt="NexusBot" style="width: 100%; max-width: 600px; margin-bottom: 20px;">
